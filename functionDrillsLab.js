...
//exclaimThree = exclaimThree.toUpperCase()
...
const bestMovie = (movieTitle) => console.log(`${movieTitle} is the best movie ever`)
...
bigOrSmall(bigOrSmallArray) // invoking, required on all functions
...
function theEliminator(arr1, str1) {
...
function changeToUpperCase(name1) {
  return name1.toUpperCase();
}

kylo = changeToUpperCase("Hi, my name is Kylo.");
...
console.log(emailCheck('     h@msn.com'))
...
let totalFrogs = calculateTotal(4, frogCost)
...
////////////////// PROBLEM 20 ////////////////////
/*
  You might have noticed a slight bug in the previous problem. If you were to pass in 4 gold, the function would return to you 1.3333... However, you can't really go to a store and buy 1.333 products. You would just be able to purchase 1 product. Re-write the function you used in the previous problem (give it the same name, just add a 2 to the end of it) that fixes this bug. Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/
...
let totalFrogs2 = calculateTotal(4, frogCost)
console.log(math.floor(totalFrogs2))
...
function arrayIsAscending(sampleArray) {
...
console.log(arrayIsAscending([i]))
...
let cuteDuck = String(globalScope)
console.log(cuteDuck)



//This array should contain the variable names (as strings) accessible in the bathroom function.
let bathroomScope = ["squeaky"]
let rubberDuck = String(bathroomScope)
console.log(rubberDuck)

//This array should contain the variable names (as strings) accessible in the bathtub function.
let bathtubScope = ["nautical"]
let sailorDuck = String(bathtubScope)
console.log(sailorDuck)

//This array should contain the variable names (as strings) accessible in the pond function.
let pondScope = ["fluffy"]
let realDuck = String(pondScope)
console.log(realDuck) 